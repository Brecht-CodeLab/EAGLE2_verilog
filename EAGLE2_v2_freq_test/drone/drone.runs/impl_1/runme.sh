...
HD_PWD='C:/Users/brech/Desktop/EAGLE2_verilog/EAGLE2_v2_freq_test/drone/drone.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log drone_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source drone_wrapper.tcl -notrace
