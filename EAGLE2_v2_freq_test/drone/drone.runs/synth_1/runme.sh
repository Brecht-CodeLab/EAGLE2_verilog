...
HD_PWD='C:/Users/brech/Desktop/EAGLE2_verilog/EAGLE2_v2_freq_test/drone/drone.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log drone_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source drone_wrapper.tcl
